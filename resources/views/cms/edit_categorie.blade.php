...
<script type="text/javascript">bkLib.onDomLoaded(nicEditors.allTextAreas);</script>  
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <form method="post" action="{{ url('cms/categories/' . $categories['id']) }}" enctype="multipart/form-data">
        ...
        <button type="submit" name="submit" class="btn btn-primary">Update categorie</button>
